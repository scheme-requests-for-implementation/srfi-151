...
(test-group "bitwise"
  ...
  (test "test-103" '(#t #f #t #f #t #t #t) (integer->list #b1110101))
  (test "test-104" '(#f #t #f #t) (integer->list #b111010 4))
  (test "test-105" '#(#t #t #t #f #t #f #t #f #f) (integer->vector #b1010111 9))
  (test "test-106" #b1110101 (list->integer '(#t #f #t #f #t #t #t)))
  (test "test-107" #b111010100 (list->integer '(#f #f #t #f #t #f #t #t #t)))
  (test "test-108" #b1110101 (vector->integer '#(#t #f #t #f #t #t #t)))
  (test "test-109" #b00011010100 (vector->integer '#(#f #f #t #f #t #f #t #t)))
  ...
  (test "test-137" 0 (integer-length 0))
  (test "test-138" 8 (integer-length 128))
  (test "test-139" 8 (integer-length 255))
  (test "test-140" 9 (integer-length 256))
  ...
  (test "test-223" '(#t #t) (integer->list 3))
  (test "test-224" '(#f #t #t #f) (integer->list 6 4))
  (test "test-225" '(#f #t) (integer->list 6 2))
  ...
  (test "test-229" 6 (list->integer '(#f #t #t)))
  (test "test-230" 12 (list->integer '(#f #f #t #t)))
  (test "test-231" 6 (list->integer '(#f #t #t #f)))
  (test "test-232" 2 (list->integer '(#f #t)))
    (test "test-233" 1 (list->integer 
  ...
  (test "test-234" #x100000000000000000000000000000000 
		 (list->integer 
		  '(#f 
		    ...
		    #f #f #f #f #f #f #f #f #f #f #f #f #f #f #f #f 
		    #f #f #f #f #f #f #f #f #f #f #f #f #f #f #f #t)))
  (test "test-235" #x03FFFFFF (list->integer '(#t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t)))
  (test "test-236" #x07FFFFFF (list->integer '(#t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t)))
  (test "test-237" #x0FFFFFFF (list->integer '(#t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t)))
  (test "test-238" #x1FFFFFFF (list->integer '(#t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t)))
  (test "test-239" #x3FFFFFFF (list->integer '(#t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t)))
  (test "test-240" #x7FFFFFFF (list->integer '(#t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t)))
  (test "test-241" #xFFFFFFFF (list->integer '(#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t 
						#t #t #t #t #t #t #t #t)))
  (test "test-242" #x1FFFFFFFF (list->integer '(#t 
					      #t #t #t #t #t #t #t #t 
					      #t #t #t #t #t #t #t #t 
					      #t #t #t #t #t #t #t #t 
					      #t #t #t #t #t #t #t #t)))
  ...
  (test "test-490" 1 (list->integer '(#t #f)))
  (test "test-501" 0 (bits))
